  ...
  server.registerPrompt(
    ...
    async ({ specName }) => {
      ...
      const prompt = joinPromptSections(
        ...
        "3. Apply practical requirements approach:",
        "   - Follow YAGNI principle: focus only on immediate, concrete user needs.",
        "   - Avoid speculative security/performance requirements unless explicitly needed.",
        "   - Defer complex architectural requirements to actual implementation phase.",
        "   - Prefer simple, actionable requirements over theoretical completeness.",
        "",
        "4. Develop requirements in the house style:",
        ...
        `- next: "Run @spec.create-design ${specName}"`,
